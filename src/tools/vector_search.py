...
# def search_table_schema(table_name, config_path):
#     """Search for table schema in Chroma vector store."""
#     logger.info(f"Searching schema for table: {table_name}")
#     config = yaml.safe_load(open(config_path))
...
#             n_results=1,
#             where={"table_name": table_name}  # Add metadata filter for precision
#         )
