...
# import yaml
# import logging
# from agents.sql_query_generator import sql_query_generator_node
...
#     graph.add_edge("action", "sql_query_generator")
#     graph.add_edge("alter", "sql_query_generator") 
...
#     try:
#         logger.info(f"Running the agent, query: {nl_text}")
#         graph = build_graph()
#         initial_state = {
